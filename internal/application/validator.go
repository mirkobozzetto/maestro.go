...
func (v *Validator) ValidateDAG(workflow *domain.Workflow) error {
...
func (v *Validator) buildStepMap(step *domain.Step, stepMap map[string]*domain.Step, deps map[string][]string) error {
